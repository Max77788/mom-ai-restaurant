...
base_url_checkout = 'https://sandboxcheckout.rapyd.net'

secret_key = os.getenv("RAPYD_SANDBOX_SECRET_KEY") # Never transmit the secret key by itself.
access_key = os.getenv("RAPYD_SANDBOX_ACCESS_KEY") # The access key received from Rapyd.
